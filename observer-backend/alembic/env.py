"""Alembic environment — async engine, reads DB URL from app config.

Per CONVENTIONS.md §5:
- Every schema change goes through here, never manual ALTER TABLE
- Autogenerate output still gets human review before commit
"""
